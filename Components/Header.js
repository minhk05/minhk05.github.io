      ...
      {!topic && (
        <div className="pt-24 px-12 mx-auto max-w-7xl">
          <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
            <p className="mb-2 text-lg font-bold text-gray-800 md:text-xl dark:text-gray-300 lg:px-4 -ml-12">
              ep0ch-l0g-dev
            </p>

            <h1 className="mb-8 text-4xl font-bold leading-none tracking-normal text-gray-900 md:text-6xl -mr-11 md:tracking-tight dark:text-gray-50">
              <span>탐구</span>{" "}
